...
Support for the [PHP 8.5 runtime](https://docs.cloud.google.com/appengine/docs/flexible/php/runtime) is in [General Availability](https://cloud.google.com/products/#product-launch-stages).
