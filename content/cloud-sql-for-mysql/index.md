...
The [C4 machine series](https://docs.cloud.google.com/sql/docs/mysql/machine-series-overview.md#c4)
...
Cloud SQL for MySQL now automatically enables point-in-time recovery (PITR) in
a separate, asynchronous operation after disaster recovery (DR) switchover and
replica failover operations complete. Because PITR enablement no longer blocks
switchover and replica failover, these operations complete faster, helping you
reduce your recovery time.

For more information, see [Use advanced disaster recovery (DR)](https://docs.cloud.google.com/sql/docs/mysql/use-advanced-disaster-recovery).
...
[Regional endpoints (REP)](https://docs.cloud.google.com/sql/docs/mysql/admin-api/rep)
are now generally available
([GA](https://cloud.google.com/products#product-launch-stages))
for the Cloud SQL for MySQL Admin API.
...
[Upgrade in place](https://docs.cloud.google.com/sql/docs/mysql/upgrade-in-place).
...
[Cloud SQL enhanced backups](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/manage-enhanced-backups)
without first removing the existing plan.
For more information, see
[Change your instance's associated backup plan](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/manage-enhanced-backups#change-plan).
...
Cloud SQL for MySQL 8.4.8 is upgraded to MySQL 8.4.10. For more information, see
the [MySQL 8.4.10 Release Notes](https://dev.mysql.com/doc/relnotes/mysql/8.4/en/news-8-4-10.html)
...
MySQL 8.0.45 is now the [default minor version](https://docs.cloud.google.com/sql/docs/mysql/db-versions#database-version-support) for Cloud SQL for MySQL 8.0.

For more information about minor version support in Cloud SQL for MySQL,
see [MySQL 8.0](https://docs.cloud.google.com/sql/docs/mysql/db-versions#mysql-8.0).
...
[About Private Service Connect](https://docs.cloud.google.com/sql/docs/mysql/about-private-service-connect#psc-outbound).
...
For more information, see [Upgrade an instance to the new network architecture](https://docs.cloud.google.com/sql/docs/mysql/upgrade-cloud-sql-instance-new-network-architecture).
...
The [Cloud SQL remote MCP server](https://docs.cloud.google.com/sql/docs/mysql/use-cloudsql-mcp)
...
Cloud SQL instance with AI assistance](https://docs.cloud.google.com/sql/docs/mysql/monitor-troubleshoot-with-ai).
...
For more information, see [Conversational analytics for Cloud SQL for MySQL overview](https://docs.cloud.google.com/gemini/data-agents/conversational-analytics/sql-mysql).
...
For more information, see [Enhanced backups](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/backup-options#enhanced-backups).
...
For more information, see [Perform a cross-project PITR](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/pitr#perform_a_cross-project_pitr).
...
[Certificate authority (CA) hierarchies](https://docs.cloud.google.com/sql/docs/mysql/authorize-ssl#ca-hierarchies).
...
Cloud SQL for MySQL now supports fast clone operations within the same zone ([GA](https://cloud.google.com/products#product-launch-stages)).

For more information, see [Clone an instance](https://docs.cloud.google.com/sql/docs/mysql/clone-instance).
...
empower your applications. For more information, see [Data agents overview](https://docs.cloud.google.com/sql/docs/mysql/data-agent-overview). This feature is available in [Preview](https://cloud.google.com/products#product-launch-stages), and access to it requires a [sign-up](https://forms.gle/pJByTWfenZAWbaXo7).
...
[point-in-time-recovery (PITR) after instance deletion](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/restore).

For more information about the available options and their limitations, see
[Backup options](https://docs.cloud.google.com/sql/docs/mysql/backup-recovery/backup-options).
