...
[Regional endpoints (REP)](https://docs.cloud.google.com/sql/docs/postgres/admin-api/rep)
are now generally available
([GA](https://cloud.google.com/products#product-launch-stages))
for the Cloud SQL for PostgreSQL Admin API.
...
The [C4 machine series](https://docs.cloud.google.com/sql/docs/postgres/machine-series-overview.md#c4)
...
[Upgrade in place](https://docs.cloud.google.com/sql/docs/postgres/upgrade-in-place).
...
authentication](https://docs.cloud.google.com/sql/docs/postgres/workforce-authentication).
...
For more information, see [Configure Private Service Connect](https://docs.cloud.google.com/sql/docs/postgres/configure-private-service-connect).
...
in [Database Center](https://docs.cloud.google.com/database-center/docs/overview) to assess and test the
...
For more information, see [Assessments in Database Center](https://docs.cloud.google.com/sql/docs/postgres/assessments-overview).
...
[DNS automation](https://docs.cloud.google.com/sql/docs/postgres/configure-dns#dns-auto)
...
For more information, see [Allowed Private Service Connect projects](https://docs.cloud.google.com/sql/docs/postgres/about-private-service-connect#allowed-psc-projects).
...
replica](https://docs.cloud.google.com/sql/docs/postgres/configure-cmek#reencrypt).
...
option](https://docs.cloud.google.com/sql/docs/postgres/backup-recovery/backup-options).
...
* Instances with [connector enforcement enabled](https://docs.cloud.google.com/sql/docs/postgres/connect-connectors#enforce)
  are eligible for planned operations with near-zero downtime.
* Instances that use [private services access](https://docs.cloud.google.com/sql/docs/postgres/configure-private-services-access)
...
feature](https://docs.cloud.google.com/sql/docs/postgres/dataplex-catalog-integration#deactivate-dataplex-catalog).

For more information, see [Near
real-time](https://docs.cloud.google.com/sql/docs/postgres/dataplex-catalog-integration#near-real-time).
...
The [Cloud SQL remote MCP server](https://docs.cloud.google.com/sql/docs/postgres/use-cloudsql-mcp)
...
your instance, see [Enable automatic server certificate rotation](https://docs.cloud.google.com/sql/docs/postgres/manage-ssl-instance#automatic-server-certificate-rotation-cas).
...
For more information, see [Best practices for securing agent interactions with Model Context Protocol](https://docs.cloud.google.com/sql/docs/postgres/secure-agent-interactions-mcp).
...
You can now use the [Cloud SQL remote MCP server](https://docs.cloud.google.com/sql/docs/postgres/use-cloudsql-mcp).
The Cloud SQL remote MCP server lets you interact easily with Cloud SQL
instances from LLMs, AI applications, and AI-enabled development platforms.
...
[Certificate authority (CA) hierarchies](https://docs.cloud.google.com/sql/docs/postgres/authorize-ssl#ca-hierarchies).
