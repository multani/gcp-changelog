...
Cloud SQL for SQL Server now supports significantly faster re-encryption of
...
replica](https://docs.cloud.google.com/sql/docs/sqlserver/configure-cmek#reencrypt).
...
[About Private Service Connect](https://docs.cloud.google.com/sql/docs/sqlserver/about-private-service-connect#psc-outbound).
...
option](https://docs.cloud.google.com/sql/docs/sqlserver/backup-recovery/backup-options).
...
Cloud SQL for SQL Server now supports regional endpoints for the Cloud SQL Admin API.
...
[Cloud SQL regional endpoints](https://docs.cloud.google.com/sql/docs/sqlserver/admin-api/rep).
