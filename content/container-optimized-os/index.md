...
| [COS-6.18.48](https://cos.googlesource.com/third_party/kernel/+/6bfdf4d7391f8e3426a22b132b8661067f86017a ) | v29.4.3 | v2.3.4 | [See List](https://storage.googleapis.com/cos-tools/19999.44.44/lakitu/gpu_driver_versions.textproto) |
...
Added kernel patch to reduce bcache garbage collection sleep
interval to prevent I/O stalls.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.18.39](https://cos.googlesource.com/third_party/kernel/+/55c4e0cbe04e12976e7f6b62068b5f1da6b3014a ) | v29.4.3 | v2.3.2 | [See List](https://storage.googleapis.com/cos-tools/19999.0.7/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/2e631b5a74208db4d7798eed9351c3ca07662e37 ) | v27.5.1 | v2.2.6 | [See List](https://storage.googleapis.com/cos-tools/19506.299.82/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.18.41](https://cos.googlesource.com/third_party/kernel/+/dc109a28deac5c57e1cbbd842102228283ea7cd0 ) | v29.4.3 | v2.3.2 | [See List](https://storage.googleapis.com/cos-tools/20012.0.0/lakitu/gpu_driver_versions.textproto) |
...
Added support for net-fs/lustre-client-drivers v2.14.0\_p256.
...
Fixes a kernel panic in virtio\_pci teardown when virtually queues are conditionally skipped.
...
Update udev rule for protected\_stateful\_partition
...
chromeos-base/hardware\_verifier\_proto to v0.0.1-r819;
...
to v0.0.1-r3050; chromeos-base/system\_api to v0.0.1-r5972;
chromeos-base/update\_engine to v0.0.3-r5184;
chromeos-base/vboot\_reference to v1.0-r2986;dev-rust/vboot\_reference-sys
...
dev-util/cvise; Removed chromeos-base/crash-reporter.
...
Updated dev-lang/rust, dev-lang/rust-host, dev-lang/rust-bootstrap to v1.84.1; dev-rust/protobuf-codegen to v2.28.0; dev-rust/system\_api to v0.24.53-r1596; dev-rust/third-party-crates-src to v0.0.1-r288.
...
Updated app-arch/gzip to v1.14\_p20260502, app-arch/xz-utils to v5.4.7, app-arch/zstd to v1.5.7, app-crypt/mit-krb5 to v1.22.2, app-editors/vim to v9.1.2148, app-editors/vim-core to v9.1.2148, dev-libs/libaio to v0.3.113-r2, dev-libs/xxhash to v0.8.3, dev-python/PySocks to v1.6.8, dev-python/markupsafe to v2.1.5, dev-python/pyrsistent to v0.14.11, dev-python/python-magic to v0.4.27, dev-python/pyyaml to v6.0.3, dev-python/rfc3339-validator to v0.1.4-r1, net-misc/rsync to v3.4.4, sys-apps/mawk to v1.3.4\_p20260302, sys-libs/libxcrypt to v4.4.38, sys-libs/talloc to v2.4.4, sys-fs/lvm2 to v2.03.39, sys-libs/binutils-libs to v2.46.1.. This resolves CVE-2025-69644.
...
Updated sys-devel/llvm to v20.0\_pre547379; sys-libs/compiler-rt to v20.0\_pre547379; sys-libs/libcxx to v20.0\_pre547379; sys-libs/llvm-libunwind to v20.0\_pre547379.
...
Upgraded app-crypt/sbsigntools to v0.42.0, and
net-misc/m2crypto to v0.42.0.
...
Fixed CVE-2026-40355 and CVE-2026-40356 in
app-crypt/mit-krb5.
...
Updated glib and gdbus-codegen to v2.89.1. This resolves
CVE-2026-58013,CVE-2026-58014,CVE-2026-58015,CVE-2026-58016.
...
Upgraded net-misc/openssh to version 10.3\_p1. This resolves
CVE-2026-35387 and CVE-2026-35388.
...
* Changed: fs.epoll.max\_user\_watches: 1808094 -> 1807627
* Changed: fs.fanotify.max\_user\_marks: 68395 -> 68378
* Changed: fs.inotify.max\_user\_watches: 64173 -> 64158
* Changed: kernel.threads-max: 63460 -> 63443
* Changed: net.ipv4.tcp\_mem: 93993 125327 187986 -> 93969 125295 187938
* Changed: net.ipv4.udp\_mem: 187989 250655 375978 -> 187941 250590 375882
* Changed: user.max\_cgroup\_namespaces: 31730 -> 31721
* Changed: user.max\_fanotify\_marks: 68395 -> 68378
* Changed: user.max\_inotify\_watches: 64173 -> 64158
* Changed: user.max\_ipc\_namespaces: 31730 -> 31721
* Changed: user.max\_mnt\_namespaces: 31730 -> 31721
* Changed: user.max\_net\_namespaces: 31730 -> 31721
* Changed: user.max\_pid\_namespaces: 31730 -> 31721
* Changed: user.max\_time\_namespaces: 31730 -> 31721
* Changed: user.max\_user\_namespaces: 31730 -> 31721
* Changed: user.max\_uts\_namespaces: 31730 -> 31721
* Changed: vm.lowmem\_reserve\_ratio: 256 256 32 0 -> 256 256 32 0 0
...
Upgraded net-misc/openssh to 10.3\_p1. to fix CVE-2026-35387, CVE-2026-35388.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/b55274a679ceb2601d9a03609106e985b577cb38 ) | v27.5.1 | v2.1.9 | [See List](https://storage.googleapis.com/cos-tools/19216.532.62/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.143](https://cos.googlesource.com/third_party/kernel/+/e8e66bd1d91bd654ea9b0f91452b6dbc02413296 ) | v27.5.1 | v2.0.10 | [See List](https://storage.googleapis.com/cos-tools/18867.528.43/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.143](https://cos.googlesource.com/third_party/kernel/+/b0b83196d5c4f472105d9376928cc3c513c17e23 ) | v24.0.9 | v1.7.34 | [See List](https://storage.googleapis.com/cos-tools/18613.675.37/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/1028c7249687e9528c5a2ec2ac154416ad9d8c50 ) | v27.5.1 | v2.2.5 | [See List](https://storage.googleapis.com/cos-tools/19506.299.60/lakitu/gpu_driver_versions.textproto) |

### Fixed

Updated udev rule for protected\_stateful\_partition
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/9afaeb55aac96322f3e70cd0cf09eb12fcd168f1 ) | v27.5.1 | v2.1.9 | [See List](https://storage.googleapis.com/cos-tools/19216.532.42/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.143](https://cos.googlesource.com/third_party/kernel/+/f4a21a19d7b0db90cb357d9082c589fbede7f6fd ) | v24.0.9 | v1.7.34 | [See List](https://storage.googleapis.com/cos-tools/18613.675.28/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/68df3c124b6c1b28325aae6b20030bd6d4e87f2c ) | v27.5.1 | v2.1.7 | [See List](https://storage.googleapis.com/cos-tools/19216.532.3/lakitu/gpu_driver_versions.textproto) |
...
Fixed CVE-2026-35388 in net-misc/openssh.
...
Fixed CVE-2026-53033 in the Linux kernel.

### Security

Fixed CVE-2026-53122 in the Linux kernel.

### Security

Fixed CVE-2026-53131 in the Linux kernel.

### Security

Fixed CVE-2026-53134 in the Linux kernel.

### Security

Fixed CVE-2026-53154 in the Linux kernel.

### Security

Fixed CVE-2026-53156 in the Linux kernel.

### Security

Fixed CVE-2026-53168 in the Linux kernel.

### Security

Fixed CVE-2026-53180 in the Linux kernel.

### Security

Fixed CVE-2026-53181 in the Linux kernel.

### Security

Fixed CVE-2026-53184 in the Linux kernel.

### Security

Fixed CVE-2026-53185 in the Linux kernel.

### Security

Fixed CVE-2026-53189 in the Linux kernel.

### Security

Fixed CVE-2026-53191 in the Linux kernel.

### Security

Fixed CVE-2026-53199 in the Linux kernel.

### Security

Fixed CVE-2026-53207 in the Linux kernel.

### Security

Fixed CVE-2026-53212 in the Linux kernel.

### Security

Fixed CVE-2026-53214 in the Linux kernel.

### Security

Fixed CVE-2026-53218 in the Linux kernel.

### Security

Fixed CVE-2026-53219 in the Linux kernel.

### Security

Fixed CVE-2026-53220 in the Linux kernel.

### Security

Fixed CVE-2026-53223 in the Linux kernel.

### Security

Fixed CVE-2026-53229 in the Linux kernel.

### Security

Fixed CVE-2026-53230 in the Linux kernel.

### Security

Fixed CVE-2026-53232 in the Linux kernel.

### Security

Fixed CVE-2026-53233 in the Linux kernel.

### Security

Fixed CVE-2026-53236 in the Linux kernel.

### Security

Fixed CVE-2026-53239 in the Linux kernel.

### Security

Fixed CVE-2026-53249 in the Linux kernel.

### Security

Fixed CVE-2026-53264 in the Linux kernel.

### Security

Fixed CVE-2026-53265 in the Linux kernel.

### Security

Fixed CVE-2026-53266 in the Linux kernel.

### Security

Fixed CVE-2026-53267 in the Linux kernel.

### Security

Fixed CVE-2026-53268 in the Linux kernel.

### Security

Fixed CVE-2026-53269 in the Linux kernel.

### Security

Fixed CVE-2026-53270 in the Linux kernel.

### Security

Fixed CVE-2026-53275 in the Linux kernel.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.94](https://cos.googlesource.com/third_party/kernel/+/a9a6e2d52bec1f807503b02b401205a67f642d04 ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.299.3/lakitu/gpu_driver_versions.textproto) |

### Change

Updated the Linux kernel to v6.12.94. It resolves CVE-2026-52908,CVE-2026-52910, CVE-2026-52912,CVE-2026-52920, CVE-2026-52921,CVE-2026-52923, CVE-2026-52925,CVE-2026-52927,CVE-2026-52928,CVE-2026-52930, CVE-2026-52933,CVE-2026-52936, CVE-2026-52942,CVE-2026-52943, CVE-2026-52946,CVE-2026-52967, CVE-2026-52969,CVE-2026-52970, CVE-2026-52972,CVE-2026-52974, CVE-2026-52977,CVE-2026-52980, CVE-2026-52981,CVE-2026-52984, CVE-2026-52986,CVE-2026-52989, CVE-2026-52990,CVE-2026-52998, CVE-2026-52999,CVE-2026-53001, CVE-2026-53002,CVE-2026-53003, CVE-2026-53006,CVE-2026-53012, CVE-2026-53013,CVE-2026-53014, CVE-2026-53021,CVE-2026-53023, CVE-2026-53031,CVE-2026-53032, CVE-2026-53033,CVE-2026-53034, CVE-2026-53035,CVE-2026-53036, CVE-2026-53038,CVE-2026-53050, CVE-2026-53053,CVE-2026-53060, CVE-2026-53061,CVE-2026-53062, CVE-2026-53063,CVE-2026-53064, CVE-2026-53069,CVE-2026-53074, CVE-2026-53075,CVE-2026-53076, CVE-2026-53080,CVE-2026-53081, CVE-2026-53083,CVE-2026-53084, CVE-2026-53085,CVE-2026-53094, CVE-2026-53096,CVE-2026-53111, CVE-2026-53115,CVE-2026-53120, CVE-2026-53122,CVE-2026-53123, CVE-2026-53126,CVE-2026-53129, CVE-2026-53132.

### Change

Updated the Linux kernel to v6.12.94. It resolves CVE-2026-52908,CVE-2026-52910, CVE-2026-52912,CVE-2026-52920, CVE-2026-52921,CVE-2026-52923, CVE-2026-52925,CVE-2026-52927, CVE-2026-52928,CVE-2026-52930, CVE-2026-52933,CVE-2026-52936, CVE-2026-52942,CVE-2026-52943, CVE-2026-52945,CVE-2026-52946, CVE-2026-52967,CVE-2026-52969, CVE-2026-52970,CVE-2026-52972, CVE-2026-52974,CVE-2026-52977, CVE-2026-52980,CVE-2026-52981, CVE-2026-52984,CVE-2026-52986, CVE-2026-52989,CVE-2026-52990, CVE-2026-52998,CVE-2026-52999, CVE-2026-53001,CVE-2026-53002, CVE-2026-53003,CVE-2026-53006, CVE-2026-53012,CVE-2026-53013, CVE-2026-53014,CVE-2026-53021, CVE-2026-53023,CVE-2026-53031, CVE-2026-53032,CVE-2026-53033, CVE-2026-53034,CVE-2026-53035, CVE-2026-53036,CVE-2026-53038, CVE-2026-53050,CVE-2026-53053, CVE-2026-53060,CVE-2026-53061, CVE-2026-53062,CVE-2026-53063, CVE-2026-53064,CVE-2026-53069, CVE-2026-53074,CVE-2026-53075, CVE-2026-53076,CVE-2026-53080, CVE-2026-53081,CVE-2026-53083, CVE-2026-53084,CVE-2026-53085, CVE-2026-53094,CVE-2026-53096, CVE-2026-53111,CVE-2026-53115, CVE-2026-53120,CVE-2026-53122, CVE-2026-53123,CVE-2026-53126, CVE-2026-53129,CVE-2026-53132.
...
Fixed CVE-2026-53235 in the Linux kernel.
...
Fixed CVE-2026-53261 in the Linux kernel.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.143](https://cos.googlesource.com/third_party/kernel/+/3a060df9faaaa8e9287e2cd1687a14f35fd7b44a ) | v27.5.1 | v2.0.8 | [See List](https://storage.googleapis.com/cos-tools/18867.528.3/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.143](https://cos.googlesource.com/third_party/kernel/+/5fdd1e8b9c34a017086bbcb058f5532b3c0298d9 ) | v24.0.9 | v1.7.31 | [See List](https://storage.googleapis.com/cos-tools/18613.675.2/lakitu/gpu_driver_versions.textproto) |
...
Upgraded the Linux kernel to v6.6.143. It resolves CVE-2026-52908,CVE-2026-52910, CVE-2026-52912,CVE-2026-52920, CVE-2026-52921,CVE-2026-52923, CVE-2026-52925,CVE-2026-52927, CVE-2026-52928,CVE-2026-52930, CVE-2026-52933,CVE-2026-52936, CVE-2026-52942,CVE-2026-52943, CVE-2026-52945,CVE-2026-52946, CVE-2026-52967,CVE-2026-52969, CVE-2026-52970,CVE-2026-52972, CVE-2026-52974,CVE-2026-52975, CVE-2026-52977,CVE-2026-52981, CVE-2026-52984,CVE-2026-52986, CVE-2026-52989,CVE-2026-52998, CVE-2026-52999,CVE-2026-53001, CVE-2026-53002,CVE-2026-53003, CVE-2026-53006,CVE-2026-53012, CVE-2026-53013,CVE-2026-53021, CVE-2026-53032,CVE-2026-53033, CVE-2026-53034,CVE-2026-53035, CVE-2026-53036,CVE-2026-53050, CVE-2026-53060,CVE-2026-53061, CVE-2026-53062,CVE-2026-53063, CVE-2026-53064,CVE-2026-53069, CVE-2026-53074,CVE-2026-53075, CVE-2026-53076,CVE-2026-53080, CVE-2026-53083,CVE-2026-53094, CVE-2026-53096,CVE-2026-53111, CVE-2026-53126.
...
Upgraded net-fs/cifs-utils to v7.6, Upgraded sys-libs/talloc to v2.4.4-r1.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.137](https://cos.googlesource.com/third_party/kernel/+/3d2eca1b468c707fe3702ad6e28719c31d6176b1 ) | v27.5.1 | v2.0.8 | [See List](https://storage.googleapis.com/cos-tools/18867.381.161/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.137](https://cos.googlesource.com/third_party/kernel/+/8b4d5a73b054b07c3abedde85bd34343fffb9566 ) | v24.0.9 | v1.7.31 | [See List](https://storage.googleapis.com/cos-tools/18613.613.40/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/dfd76308ba62f00253b0f99cf10089931d12241d ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.120.97/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.137](https://cos.googlesource.com/third_party/kernel/+/068bbd7c450db6c0538186d272865f74efd74316 ) | v27.5.1 | v2.0.8 | [See List](https://storage.googleapis.com/cos-tools/18867.381.132/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.85](https://cos.googlesource.com/third_party/kernel/+/5241cda1d789949bbcddde5d9320a36c610237d4 ) | v27.5.1 | v2.1.7 | [See List](https://storage.googleapis.com/cos-tools/19216.395.31/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.137](https://cos.googlesource.com/third_party/kernel/+/3b26f2eb5b1d5bcf6947c6656262e5b073999775 ) | v24.0.9 | v1.7.29 | [See List](https://storage.googleapis.com/cos-tools/18613.613.15/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/261ec2a82c20483a919d7d25c05c7138ed1859c8 ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.120.64/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.85](https://cos.googlesource.com/third_party/kernel/+/8615dfb7470816ab28b148bb67bba5f12bb4ea0b ) | v27.5.1 | v2.1.7 | [See List](https://storage.googleapis.com/cos-tools/19216.395.4/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/ab5449e6af743561ec3d078ea8fcec22a07d8e75 ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.120.52/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/8656d3e850e89f3430c31b56ebae60096f99a71b ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.120.44/lakitu/gpu_driver_versions.textproto) |
...
Enabled CONFIG\_SCHED\_CLASS\_EXT and CONFIG\_EXT\_GROUP\_SCHED.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/494b0342b38b614242985fa139fc510253b3b81f ) | v27.5.1 | v2.2.3 | [See List](https://storage.googleapis.com/cos-tools/19506.120.15/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.123](https://cos.googlesource.com/third_party/kernel/+/adc0dc9357977720199f700bbea8912f61c934a9 ) | v24.0.9 | v1.7.29 | [See List](https://storage.googleapis.com/cos-tools/18613.534.62/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.1.161](https://cos.googlesource.com/third_party/kernel/+/bd30b98f1ad2d619c26425f9698025613037e170 ) | v24.0.9 | v1.7.27 | [See List](https://storage.googleapis.com/cos-tools/18244.582.62/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.122](https://cos.googlesource.com/third_party/kernel/+/881eed6735256ed08c042b5ae37423670343957b ) | v27.5.1 | v2.0.7 | [See List](https://storage.googleapis.com/cos-tools/18867.381.63/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.67](https://cos.googlesource.com/third_party/kernel/+/3c72f15648aedcf11689537f9545addd4377da5f ) | v27.5.1 | v2.2.2 | [See List](https://storage.googleapis.com/cos-tools/19506.0.121/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.77](https://cos.googlesource.com/third_party/kernel/+/350c271d1b528bc4fe572d2cadd2a16c3a758e41 ) | v27.5.1 | v2.2.1 | [See List](https://storage.googleapis.com/cos-tools/19681.0.0/lakitu/gpu_driver_versions.textproto) |
...
Fixed a kernel panic in virtio\_pci teardown when virtually queues are conditionally skipped.
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.68](https://cos.googlesource.com/third_party/kernel/+/f66bf9eb15aea83cae027143806b6af01481c296 ) | v27.5.1 | v2.1.5 | [See List](https://storage.googleapis.com/cos-tools/19216.220.117/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.1.161](https://cos.googlesource.com/third_party/kernel/+/da5dc8347ba20698e2b8e3a27f2f4b5783e11c98 ) | v24.0.9 | v1.7.27 | [See List](https://storage.googleapis.com/cos-tools/18244.582.40/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.123](https://cos.googlesource.com/third_party/kernel/+/810772cc40b9bc07245d9d7059e7f2d697995adf ) | v24.0.9 | v1.7.29 | [See List](https://storage.googleapis.com/cos-tools/18613.534.35/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.122](https://cos.googlesource.com/third_party/kernel/+/894f17dcc8a978b3bd6e85e3cfe41e97d55a87d8 ) | v27.5.1 | v2.0.7 | [See List](https://storage.googleapis.com/cos-tools/18867.381.30/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.67](https://cos.googlesource.com/third_party/kernel/+/6a94838554b0bb000df16504d3a1e893f6822085 ) | v27.5.1 | v2.2.0 | [See List](https://storage.googleapis.com/cos-tools/19506.0.17/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.123](https://cos.googlesource.com/third_party/kernel/+/55925dbc98fdf4fb587279b50d8bf5691279f7a5 ) | v24.0.9 | v1.7.29 | [See List](https://storage.googleapis.com/cos-tools/18613.534.2/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.6.122](https://cos.googlesource.com/third_party/kernel/+/fb58ee65b976db7511889e450eea774c01a7e705 ) | v27.5.1 | v2.0.7 | [See List](https://storage.googleapis.com/cos-tools/18867.294.134/lakitu/gpu_driver_versions.textproto) |
...
| --- | --- | --- | --- |
| Kernel | Docker | Containerd | [GPU Drivers](https://cloud.google.com/container-optimized-os/docs/how-to/run-gpus) |
| [COS-6.12.68](https://cos.googlesource.com/third_party/kernel/+/0f7fdc11309c4368bee6047b0946cf23a718ec27 ) | v27.5.1 | v2.1.5 | [See List](https://storage.googleapis.com/cos-tools/19216.220.9/lakitu/gpu_driver_versions.textproto) |
