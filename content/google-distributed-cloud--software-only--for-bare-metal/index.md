...
Google Distributed Cloud (software only) for bare metal 1.34.900-gke.135 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.34.900-gke.135 runs on Kubernetes v1.34.7-gke.200.
...
* Fixed vulnerabilities listed in [Vulnerability fixes](https://docs.cloud.google.com/kubernetes-engine/distributed-cloud/bare-metal/docs/vulnerabilities).
* Fixed an issue where the status for `Ingress` resources was not updated when
  using bundled Ingress.
...
* Fixed an issue where deleting a cluster could get stuck because the node pool
  controller attempted to recreate machine resources while cluster deletion was in
  progress.
...
Google Distributed Cloud (software only) for bare metal 1.33.1200-gke.83 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.1200-gke.83 runs on Kubernetes v1.33.11-gke.100.
...
Google Distributed Cloud (software only) for bare metal 1.35.400-gke.81 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.35.400-gke.81 runs on Kubernetes v1.35.3-gke.400.
...
Google Distributed Cloud (software only) for bare metal 1.33.1100-gke.72 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.1100-gke.72 runs on Kubernetes v1.33.11-gke.100.
...
Google Distributed Cloud (software only) for bare metal 1.34.700-gke.93 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.34.700-gke.93 runs on Kubernetes v1.34.7-gke.200.
...
* Removed the deprecated `csi-snapshot-validation-webhook` component. Upstream Kubernetes validation is now handled natively via Common Expression Language (CEL) rules within the deployed Custom Resource Definitions (CRDs). For more information, see [Volume snapshots](https://docs.cloud.google.com/kubernetes-engine/docs/how-to/persistent-volumes/volume-snapshots).
...
Google Distributed Cloud (software only) for bare metal 1.35.300-gke.87 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.35.300-gke.87 runs on Kubernetes v1.35.3-gke.400.
...
Google Distributed Cloud (software only) for bare metal 1.33.1000-gke.59 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.1000-gke.59 runs on Kubernetes v1.33.11-gke.100.
...
Google Distributed Cloud (software only) for bare metal 1.33.900-gke.90 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.900-gke.90 runs on Kubernetes v1.33.11-gke.100.
...
Google Distributed Cloud (software only) for bare metal 1.33.800-gke.75 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.800-gke.75 runs on Kubernetes v1.33.11-gke.100.
...
Google Distributed Cloud (software only) for bare metal 1.34.400-gke.88 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.34.400-gke.88 runs on Kubernetes v1.34.6-gke.200.
...
* Fixed an issue where node upgrades could hang indefinitely and bypass the
  ...
  completed pods within a namespace that was in a `Terminating`
  ...
  allowing the upgrade to proceed normally.
...
Google Distributed Cloud (software only) for bare metal 1.33.700-gke.71 is now available for
download. To upgrade, see [Upgrade clusters](how-to/upgrade).
Google Distributed Cloud for bare metal
1.33.700-gke.71 runs on Kubernetes v1.33.5-gke.2200.
