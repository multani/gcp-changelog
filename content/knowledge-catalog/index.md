...
Knowledge Catalog connectors for importing metadata from SQL Server and
PostgreSQL data sources are available in [Preview](https://cloud.google.com/products#product-launch-stages).
...
and [Manage connector jobs](https://docs.cloud.google.com/dataplex/docs/manage-connector-jobs).
