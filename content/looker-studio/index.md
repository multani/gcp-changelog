...
Users of Looker Studio Pro can create hourly schedules for [report delivery](https://docs.cloud.google.com/looker/docs/studio/schedule-automatic-report-delivery) and [alerts](https://docs.cloud.google.com/looker/docs/studio/create-alerts-on-a-chart).
