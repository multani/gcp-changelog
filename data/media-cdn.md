...
typically selected to be near your centralized origin. This feature is in **Preview**.## 2025-06-18 00:00:00-07:00
...
For an example, see [Example: Block traffic from known malicious IPs](https://cloud.google.com/media-cdn/docs/security-policies#example-block-malicious-using-NTI).### Feature
