...
General availability: The Go Pub/Sub client library v1 version is now upgraded to the v2 version. For more information, see the [Migration guide](https://github.com/googleapis/google-cloud-go/blob/main/pubsub/MIGRATING.md).
